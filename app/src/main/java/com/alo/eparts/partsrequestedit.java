...
public class partsrequestedit extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partsrequestedit);
        ...
        call.enqueue(new Callback<ArrayList<BrandData>>() {
            ...
            public void onResponse(Call<ArrayList<BrandData>> call, Response<ArrayList<BrandData>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    ArrayAdapter<String> adapterTime = new ArrayAdapter<>(partsrequestedit.this, R.layout.dropdownbrand_item, codes);
                    ...
                    autocompleteTV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Toast.makeText(partsrequestedit.this, "" + BrandDataArrayList.get(position).getId(), Toast.LENGTH_SHORT).show();
                        }
        ...
        call.enqueue(new Callback<ArrayList<ModelData>>() {
            ...
            public void onResponse(Call<ArrayList<ModelData>> call, Response<ArrayList<ModelData>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    ArrayAdapter<String> adapterTime = new ArrayAdapter<>(partsrequestedit.this, R.layout.dropdownmodel_item, model);
